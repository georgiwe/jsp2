// I got the lectures array off the forum, didnt feel like writing it myself.
// The rest is all me :P
var lectures = [{
...
var templateString = document.getElementById('table-template').innerHTML;
var template = Handlebars.compile(templateString);

var tableHTML = template({ lectures: lectures });
